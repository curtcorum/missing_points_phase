...
%% @end deftypefn
%
% modified for matlab compatibility by Curt Corum, 1/4/2018
...
if (nargin < 2 || nargin > 4)
    %print_usage ();
    help(mfilename);
elseif (~ isvector (padsize) || ~ isnumeric (padsize) || any (padsize < 0) || any (padsize ~= fix (padsize)))
...
if (fancy_pad)
    ...
    circular = false; replicate = false; symmetric = false; reflect = false;
